...
; CONFIG1
  ...
  CONFIG MCLRE = OFF ; Master Clear en pin ((PORTE) and 07Fh), 3 deshabilitado
...
via1_verde_titilante:
    ...
    btfss PORTA,2 ; si esta encendido lo apaga
    bsf PORTA,2
    btfsc PORTA,2
    bcf PORTA,2

    decfsz detener_verde_titilante, F
    return
...
config_reloj:
    banksel OSCCON
    bcf ((OSCCON) and 07Fh), 6 ; IRCF = 011 (500kHz)
